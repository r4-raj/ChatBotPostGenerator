      ...
      <section className="bg-gradient-to-br from-blue-600 via-purple-600 to-purple-700 py-24">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-4xl mx-auto mb-12">
            Start free and scale as you grow. Choose the plan that fits your business needs. Upgrade
            or downgrade anytime with no commitments.
          </p>
          ...
          <div className="bg-blue-500/20 border border-blue-400/30 rounded-lg p-4 max-w-4xl mx-auto mb-12">
            <div className="flex items-center justify-center">
              ...
              <span className="ml-2 text-blue-100">
                Choose your plan and we'll guide you through creating your account and business setup.
              </span>
            </div>
          </div>
        </div>
            ...
            <table className="w-full max-w-6xl mx-auto border-collapse">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  <th className="text-left py-6 px-6 font-semibold text-gray-900 w-1/4">Features</th>
                  <th className="text-center py-6 px-6 font-semibold text-gray-900 w-1/6">Free</th>
                  <th className="text-center py-6 px-6 font-semibold text-gray-900 w-1/6">Starter</th>
                  ...
                  <th className="text-center py-6 px-6 font-semibold text-gray-900 w-1/6">Enterprise</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-gray-50">
                  <td className="py-5 px-6 font-medium text-gray-900">Monthly Price</td>
                  <td className="py-5 px-6 text-center text-green-600 font-bold">Free</td>
                  <td className="py-5 px-6 text-center font-bold">₹{isAnnual ? '41' : '49'}</td>
                  <td className="py-5 px-6 text-center font-bold">₹{isAnnual ? '124' : '149'}</td>
                  <td className="py-5 px-6 text-center font-bold">₹{isAnnual ? '415' : '499'}</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="py-5 px-6 text-gray-700">AI-generated posts per month</td>
                ...
                <tr className="hover:bg-gray-50">
                  <td className="py-5 px-6 text-gray-700">Social media accounts</td>
                ...
                <tr className="hover:bg-gray-50">
                  <td className="py-5 px-6 text-gray-700">Advanced analytics</td>
                  <td className="py-5 px-6"><div className="flex justify-center items-center h-6"><XIcon /></div></td>
                  <td className="py-5 px-6"><div className="flex justify-center items-center h-6"><CheckIcon /></div></td>
                  <td className="py-5 px-6"><div className="flex justify-center items-center h-6"><CheckIcon /></div></td>
                  <td className="py-5 px-6"><div className="flex justify-center items-center h-6"><CheckIcon /></div></td>
                </tr>
                <tr className="hover:bg-gray-50">
                ...
                <tr className="hover:bg-gray-50">
                  <td className="py-5 px-6 text-gray-700">White-label options</td>
                  <td className="py-5 px-6"><div className="flex justify-center items-center h-6"><XIcon /></div></td>
                  <td className="py-5 px-6"><div className="flex justify-center items-center h-6"><XIcon /></div></td>
                  <td className="py-5 px-6"><div className="flex justify-center items-center h-6"><XIcon /></div></td>
                  <td className="py-5 px-6"><div className="flex justify-center items-center h-6"><CheckIcon /></div></td>
          ...
          {/* Free Plan */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 mb-6">Perfect for individuals and small creators getting started</p>
                <div className="mb-6">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">4 AI-generated posts per month</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">1 social media platform</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon />
                  ...
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">Content templates library</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
              <div className="text-center mb-8">
                ...
                <div className="mb-6">
                  <span className="text-4xl font-bold text-gray-900">₹{isAnnual ? '41' : '49'}</span>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">30 AI-generated posts per month</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">3 social media platforms</span>
                  </li>
              <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">Advanced scheduling automation</span>
              </li>
              <li className="flex items-center">
                    <CheckIcon />
            ...
            <div className="bg-blue-600 rounded-2xl p-8 shadow-xl border-2 border-blue-500 relative transform scale-105 mt-6">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-blue-100 mb-6">Ideal for growing businesses and agencies</p>
                <div className="mb-6">
                  <span className="text-4xl font-bold text-white">₹{isAnnual ? '124' : '149'}</span>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-blue-100">200 AI-generated posts per month</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-blue-100">5 social media platforms</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-blue-100">Advanced scheduling & automation</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon />
              ...
              <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-blue-100">Custom content templates</span>
              </li>
              <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-blue-100">Advanced analytics & reporting</span>
              </li>
              <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-blue-100">Multi-platform publishing</span>
              </li>
              <li className="flex items-center">
                    <CheckIcon />
              ...
              <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-blue-100">Performance optimization</span>
              </li>
            </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
              <div className="text-center mb-8">
                ...
                <div className="mb-6">
                  <span className="text-4xl font-bold text-gray-900">₹{isAnnual ? '415' : '499'}</span>
                  <span className="text-gray-500 ml-2">/month</span>
                </div>
                <button className="w-full bg-gray-900 text-white py-3 px-6 rounded-lg font-semibold hover:bg-gray-800 transition-colors">
                  Get Started
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">Unlimited AI-generated posts</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">Unlimited social media platforms</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">Full automation suite</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">24/7 dedicated support</span>
                  </li>
                  <li className="flex items-center">
                    <CheckIcon />
                  ...
                  <li className="flex items-center">
                    <CheckIcon />
                    <span className="ml-3 text-gray-700">White-label options</span>
                  </li>
              <li className="flex items-center">
                    <CheckIcon />
